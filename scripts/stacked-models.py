...
cv_result = xgb.cv(xgb_params,
                   dtrain,
                   num_boost_round=num_boost_rounds, # increase to have better results (~700)
...
print "==============num boost rounds===========%d"%(num_boost_rounds)
# train model
...
sub.to_csv('results/stacked-models.csv', index=False)
